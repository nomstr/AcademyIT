...
namespace Module_7_Unit_Test_Project
{
    ...
    public class StressTestCaseTest
    {
        ...
        public void StressTestCaseConstructorTest()
        {
            ...
            int heightInMm = 32;
            int widthInMm = 18;
            string expected = "Material: Composite, CrossSection: CShaped, Length: 5000mm, Height: 32mm, Width: 18mm, No Stress Test Perfomed";
        ...
        {
            string expected = "Material: StainlessSteel, CrossSection: IBeam, Length: 4000mm, Height: 20mm, Width: 15mm, No Stress Test Perfomed";
